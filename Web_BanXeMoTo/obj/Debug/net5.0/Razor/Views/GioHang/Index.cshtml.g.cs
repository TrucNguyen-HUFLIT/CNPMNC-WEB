#pragma checksum "F:\HUFLIT-EDU\năm3\Semester2\DA1-CNPMNC\CNPM\CNPMNC-WEB\Web_BanXeMoTo\Views\GioHang\Index.cshtml" "{ff1816ec-aa5e-4d10-87f7-6f4963833460}" "a8722ed122d2ac03595a769fb3828a1b3d3324db"
// <auto-generated/>
...
#line hidden
#nullable disable
    [global::Microsoft.AspNetCore.Razor.Hosting.RazorSourceChecksumAttribute(@"SHA1", @"a8722ed122d2ac03595a769fb3828a1b3d3324db", @"/Views/GioHang/Index.cshtml")]
            ...
            <div class=""col-md-12"">
                <div class=""cart-view-area"">
                    <div class=""cart-view-table"">
                        ");
            __tagHelperExecutionContext = __tagHelperScopeManager.Begin("form", global::Microsoft.AspNetCore.Razor.TagHelpers.TagMode.StartTagAndEndTag, "a8722ed122d2ac03595a769fb3828a1b3d3324db4251", async() => {
                WriteLiteral(@"
...
#nullable disable
    ...
    <script>
            ...
            $("".ajax-minus"").click(function () {
                $.ajax({
                    ...
                    success: function (data) {
                        ...
                        $(""#thanhTien_"" + data.id).html(data.thanhTien);
      ...
      ");
                WriteLiteral(@"                  $(""#cart_count"").html(data.total);
                        $(""#soLuong_"" + data.id).html(data.soLuong);
                        $(""#thanhTien_"" + data.id).html(data.thanhTien);
                        console.log(data)

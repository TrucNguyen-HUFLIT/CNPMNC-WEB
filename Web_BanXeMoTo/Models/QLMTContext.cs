...
{
    public partial class QLMTContext : DbContext
    {
        public QLMTContext()
        {
        }

        public QLMTContext(DbContextOptions<QLMTContext> options)
            : base(options)
        {
        }
...
<<<<<<< HEAD:Web_BanXeMoTo/Models/QLMTContext.cs
                optionsBuilder.UseSqlServer("Server=DESKTOP-1N34MNR;Database=QLMT;Trusted_Connection=True;");
=======
                optionsBuilder.UseSqlServer("Server=DESKTOP-I7EOLFR\\SQLEXPRESS;Database=QLMT;Trusted_Connection=True;");
>>>>>>> master:Web_BanXeMoTo/Models/QLMoToContext.cs
            }
        }
        ...
        protected override void OnModelCreating(ModelBuilder modelBuilder)
        {
            ...
            {
                entity.HasKey(e => e.IdloaiXe);

                entity.ToTable("LoaiXe");

                entity.Property(e => e.IdloaiXe)
                    .HasMaxLength(50)
            ...
            modelBuilder.Entity<MauXe>(entity =>
            {
                ...
                entity.HasOne(d => d.IdloaiXeNavigation)
                    .WithMany(p => p.MauXes)
                    .HasForeignKey(d => d.IdloaiXe)
                    .HasConstraintName("FK_MauXe_LoaiXe");
            });
            ...
            modelBuilder.Entity<Xe>(entity =>
            {
                ...
                entity.HasOne(d => d.IdmauNavigation)
                    ...
                    .HasForeignKey(d => d.Idmau)
                    .OnDelete(DeleteBehavior.ClientSetNull)
                    .HasConstraintName("FK_Xe_MauXe1");
            });
